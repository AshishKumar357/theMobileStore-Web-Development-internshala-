                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body text-center">
                        ...
                        <?php if (!isset($_SESSION['email'])) { ?> 
                            <p>
                                <a href="login.php" role="button" class="btn btn-primary btn-block">Order Now!</a>
                            </p> 
                            <?php
                        } else {  
                            if (check_if_added_to_cart(1)) { 
                                ...
                                ?> 
                                <a href="Cart-add.php?id=1" name="add"  class="btn btn-block btn-primary">Order Now!</a> 
                                <?php
                            }
                        }
                        ?>
                    ...
                    <div class="panel-body text-center">
                        ...
                        <?php if (!isset($_SESSION['email'])) { ?> 
                            ...
                            if (check_if_added_to_cart(2)) { 
                                ...
                                ?> 
                                <a href="Cart-add.php?id=2" name="add"  class="btn btn-block btn-primary">Order Now!</a> 
                                <?php
                            }
                        }
                        ?>
                    ...
                    <div class="panel-body text-center">
                        ...
                        <?php if (!isset($_SESSION['email'])) { ?> 
                            ...
                            if (check_if_added_to_cart(3)) { 
                                ...
                                ?> 
                                <a href="Cart-add.php?id=3" name="add"  class="btn btn-block btn-primary">Order Now!</a> 
                                <?php
                            }
                        }
                        ?>
                    ...
                    <div class="panel-body text-center">
                        ...
                        <?php if (!isset($_SESSION['email'])) { ?> 
                            ...
                            if (check_if_added_to_cart(4)) { 
                                ...
                                ?> 
                                <a href="Cart-add.php?id=4" name="add"  class="btn btn-block btn-primary">Order Now!</a> 
                                <?php
                            }
                        }
                        ?>
                    ...
                    <div class="panel-body text-center">
                       ...
                       <?php if (!isset($_SESSION['email'])) { ?> 
                            ...
                            if (check_if_added_to_cart(5)) { 
                                ...
                                ?> 
                                <a href="Cart-add.php?id=5" name="add"  class="btn btn-block btn-primary">Order Now!</a> 
                                <?php
                            }
                        }
                        ?>
                    ...
                    <div class="panel-body text-center">
                        ...
                        <?php if (!isset($_SESSION['email'])) { ?> 
                            ...
                            if (check_if_added_to_cart(6)) { 
                                ...
                                ?> 
                                <a href="Cart-add.php?id=6" name="add"  class="btn btn-block btn-primary">Order Now!</a> 
                                <?php
                            }
                        }
                        ?>
